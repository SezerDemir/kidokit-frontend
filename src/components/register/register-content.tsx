...
export function RegisterContent(){
    ...
    const [repeatPasswordCheck, setRepeatPasswordCheck] = useState<boolean>(false);
    ...
    return(
        <form className={styles["register-content-container"]} onSubmit={handleSubmit}>
            ...
            <div className={styles["email-cell"]}>
                ...
                <input type={"text"} id="input-email" onChange={handleInputChange}/>
            </div>
            
            <div className={styles["password-cell"]}>
                <h1>Bir şifre belirleyiniz</h1>
                <input type={passwordShown ? "text" : "password"} onChange={validatePassword} id="input-password"/>
            ...
            <div className={styles["kid-name-cell"]}>
                <h1>Çocuğun ismi?</h1>
                <input type="text" id="input-kid-name" onChange={handleInputChange}/>
            </div>

            <div className={styles["kid-birthday-cell"]}>
                <h1>Çocuğun Doğum Tarihi?</h1>
                <input type={"date"} id="input-date" onChange={handleInputChange} />
            </div>
